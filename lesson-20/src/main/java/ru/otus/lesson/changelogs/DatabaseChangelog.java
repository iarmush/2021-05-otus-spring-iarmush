...
public class DatabaseChangelog {
    ...
    public void initAuthors(AuthorRepository authorRepository) {
        author1 = authorRepository.save(new Author("a1")).block();
        author2 = authorRepository.save(new Author("a2")).block();
        author3 = authorRepository.save(new Author("a3")).block();
    }

    @ChangeSet(order = "002", id = "initGenres", author = "iarmush", runAlways = true)
    public void initGenres(GenreRepository genreRepository) {
        genre1 = genreRepository.save(new Genre("g1")).block();
        genre2 = genreRepository.save(new Genre("g2")).block();
        genre3 = genreRepository.save(new Genre("g3")).block();
    }
