...
@ShellComponent
public class Lesson09Commands {

    private final LibraryService libraryService;

    public Lesson09Commands(LibraryService libraryService) {
    ...
    @ShellMethod(value = "Read comment", key = {"read-comment-by-book-title"})
    ...
    public void deleteComment(String text) {
        libraryService.deleteCommentByText(text);
    }
}
